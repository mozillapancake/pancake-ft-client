...
* Ported to dojo-less AMD format
*/
define(
  ["store/util/QueryResults", "store/util/SimpleQueryEngine", "./lib/json"],
  function(QueryResults, SimpleQueryEngine, json) {
    ...
    LocalStorage.prototype = {
        ...
        get: function(id){
            ...
            return itemStr ? json.fromJson(itemStr) : undefined;
        },
